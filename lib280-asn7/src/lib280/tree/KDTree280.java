...
public class KDTree280 {
	...
	/**
	 * *  Create a new kd-tree with specified dimension.
	 * 
	 * @param dim Dimension of points in the tree.
	 */
	 ...
	 *         
	 */
	private void findMedian(NDPoint280 points[], int left, int right, int d, int k) throws IllegalArgumentException {
	...
	/**
	 * Build a kd-tree from an array of n-dimensional points
	 * 
	 * @param points Array of points to add to the kd-tree
	 ...
	 * 
	 * 
	 * @param points Array of points from which to construct the kd-tree.
	 * @precond All of the N-dimensional points in the input array must have dimension equal to the dimension of the kd-tree (this.dim).
	 * @precond The values in the i-th coordinate of all points in the input array are unique
	...
	/**
	 * Helper method to do a range search of the tree.
	 * 
	 ...
	 * @param level The level of the tree where 'curNode' resides.
	 */
	...
	/**
	 * Perform a range search on the tree given the lower and upper bounds on each coordinate axis.
	 * 
	 * @param lower The lower bounds on the coordinate ranges.
	 * @param upper The upper bounds on the coordinate ranges.
	 * 
	 * @return A list of points in the tree that are in range.
	 * 
	 * @precond The dimensions of upper and lower must be the same as that of the tree (this.dim).
	 */
	...
	/**
	 * Helper method.  Prints a human readable version of the tree.
	 * @param rt The current node.
	 * @param i The level in the tree of the current node.
	...
	protected String toStringByLevel(KDNode280 rt, int i) 
	{
		...
		if (rt != null && (root.leftNode() != null || rt.rightNode() != null))
		...
		{
			result += rt.toString();
			if (root.leftNode() != null || rt.rightNode() != null)
	...
	public static void main(String[] args) {
		...
		// First range search test of 3D tree
		System.out.println();
		...
		// Second range search test of 3D tree
		double lower2[] = {0, 1, 0};
		double upper2[] = {8, 7, 4};
